...
public class MenuFragment extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		 ...
		 menuFragment = inflater.inflate(R.layout.menu,
				container, false);
		return menuFragment;
	}
@Override
public void onResume() {
	...
	map.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			homeActivity.commitFragment(R.id.mainContainer, new MenuFragment(), "map", null);
	...
	favorite.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			homeActivity.commitFragment(R.id.mainContainer, new favoriteFragment(), "favorite", null);
		}
	});
}
@Override
